...
| **📜** | **Listado de pr de nuestro proyecto**<br> _Se agrupan las pr mas relevantes en las categorias features, bugfix y chores/refactors de nuestro front end y back end_ | [lista de pr del Front End](docs/gestion/listado-de-pr/front-end.md)<br><br>[lista de pr del Back End](docs/gestion/listado-de-pr/back-end.md) |
