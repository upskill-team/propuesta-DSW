...
| **📜** | **Listado de pr de nuestro proyecto**<br> _Se agrupan las pr mas relevantes en las categorias features, bugfix y chores/refactors de nuestro front end y back end_ | [Lista PRs Feat/Bugs Front](./listado-de-pr/front-end.md)<br><br>[Lista PRs Feat/Bugs Back](./listado-de-pr/back-end.md) |
